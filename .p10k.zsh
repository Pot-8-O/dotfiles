# Generated by Powerlevel10k configuration wizard on 2020-06-17 at 13:37 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|upsertSecret|upsertCredentials|kubesecret|kubeforward|kubeshell|kubelog|kuberestart'
